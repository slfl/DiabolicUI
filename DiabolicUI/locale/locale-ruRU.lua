...
L["Show battlefield status"] = "Показывать статусы поля боя"
L["Shows the battlefield status text (bases, victory points) to the left of the minimap."] = "Показывает текст статусов поля боя (базы, очки победы) слева от мини-карты."
L["Show capture bar"] = "Показывать полосу захвата"
L["Shows the capture-point bar with the sliding Alliance / Horde indicator."] = "Показывает полосу захвата точки с движущимся индикатором Альянс / Орда."
L["Color text by faction"] = "Цвет текста по фракции"
L["Colors the status text blue for Alliance and red for Horde."] = "Окрашивает текст статусов синим для Альянса и красным для Орды."
