...
L["Custom minimap"] = "Diablo minimap"
L["Shows the custom square minimap. Turn off to use another minimap addon. Requires a relog to take effect."] = true
L["The minimap change will take effect after your next relog."] = true
L["24-hour clock"] = true
L["Use a 24-hour clock (15:55) instead of 12-hour (3:55 PM)."] = true
L["Use slash in date"] = true
L["Separate the date with a slash (05/07) instead of a dot (05.07)."] = true
L["Show addon buttons"] = true
L["Show the collapsible addon-button holder under the minimap."] = true
L["Show vignette"] = true
L["Show a dark vignette overlay on the minimap."] = true
L["Vignette strength"] = true
L["Adjust the vignette opacity."] = true
L["Minimap opacity"] = true
L["Adjust the overall minimap opacity."] = true
L["Date format"] = true
L["Day only"] = true
L["Day and month"] = true
L["Day, month and year"] = true
L["Date separator"] = true
L["Dot (.)"] = true
L["Colon (:)"] = true
L["Slash (/)"] = true
L["Command bar"] = true
L["Minimap"] = true
L["About"] = true
L["A Diablo-style UI modification."] = true
L["Version"] = true
L["Author"] = true
L["Category"] = true
L["Interface"] = true
...
L["Client"] = true
L["Chat"] = true
L["Show message timestamp"] = true
L["Shows the time before each chat message."] = true
L["Timestamp format"] = true
L["Wrap time in brackets"] = true
L["Wraps the timestamp in square brackets, e.g. [15:55]."] = true
L["Timestamp changes apply to new messages."] = true
L["Show chat buttons"] = true
L["Shows the up / down / bottom scroll buttons on the chat window."] = true
L["Background darkness"] = true
L["Adjust the darkness of the chat background."] = true
L["Copy chat"] = true
L["Enhanced chat"] = true
L["Applies the dark Diablo chat styling, buttons and copy window. Requires a relog to take effect."] = true
L["The chat change will take effect after your next relog."] = true
L["Hide friends button"] = true
L["Hides the friends (Social) button above the chat. The one by the input line stays."] = true
L["Original"] = true
L["Time"] = true
L["Server time"] = true
L["Local time"] = true
...
L["Never"] = true
L["Battlefield"] = true
L["Show battlefield status"] = true
L["Shows the battlefield status text (bases, victory points) to the left of the minimap."] = true
L["Show capture bar"] = true
