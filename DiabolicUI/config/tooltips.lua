...
local config = {
	...
	custom = {
		...
		item = {
			...
			title_left_texture = path .. [[textures\tooltips\DiabolicUI_Tooltip_TitleDecoration.tga]],
			title_left_offset = -5,
			title_left_size = { 32, 64 },
			title_left_texcoord = { 0, 31/128, 0, 1 },

			title_top_texture = path .. [[textures\tooltips\DiabolicUI_Tooltip_TitleDecoration.tga]],
			title_top_offset = 12,
			title_top_size = { 64, 64 },
			title_top_texcoord = { 32/128, 95/128, 0, 1 },

			title_right_texture = path .. [[textures\tooltips\DiabolicUI_Tooltip_TitleDecoration.tga]],
			...
			icon_border = {
				texture = path .. [[textures\tooltips\DiabolicUI_Tooltip_IconBorder.tga]],
				texcoord = { 0, 1, 0, 1 },
				size = { 64, 64 },
